/** In this mode the snake does not eat its self
 and still growing until touch the sides of the board */

import javax.swing.*;
import java.awt.*;
import java.awt.event.*;

public class GamePanel2 extends JPanel implements GameContents, ActionListener {
    public int SPEED;
